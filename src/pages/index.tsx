...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{width: '100%', height: '100%', position: 'relative', background: '#141414'}}>
    <div style={{left: 1060, top: 46, position: 'absolute', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 48, display: 'inline-flex'}}>
        <div style={{color: 'white', fontSize: 20, fontFamily: 'Roboto', fontWeight: '700', textTransform: 'capitalize', wordWrap: 'break-word'}}>Home</div>
        <div style={{color: 'white', fontSize: 20, fontFamily: 'Roboto', fontWeight: '400', textTransform: 'capitalize', wordWrap: 'break-word'}}>Saved</div>
    ...
    <div style={{width: 1363, height: 400, left: 38, top: 111, position: 'absolute', background: '#D9D9D9', borderRadius: 5}} />
